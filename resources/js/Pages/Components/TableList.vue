...
<template>
	<article v-for="table in tableList" :key="table.id"
		 class="accordion">
		<div class="accordion-head">
			...
			<button v-else @click.prevent="$emit('addOrder',table.id)">New Order</button>
		</div>
		<div class="accordion-content">
			...
			<div>
				<button @click.prevent="$emit('addOrder',table.id)">Add Items</button>
			</div>
		</div>
	</article>
</template>
